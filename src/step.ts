...
// STEP
export type StepType = 'swap' | 'cross' | 'fenix'
...
export interface FenixStep extends StepBase {
  type: 'fenix'
  action: Action
  estimate: Estimate
  includedSteps: Step[]
...
export function isFenixStep(step: Step): step is FenixStep {
  return step.type === 'fenix'
}

export type Step = SwapStep | CrossStep | FenixStep
